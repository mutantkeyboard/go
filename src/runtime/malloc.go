...
const (
	...
	_MHeapMap_TotalBits = (_64bit*sys.GoosWindows)*35 + (_64bit*(1-sys.GoosWindows)*(1-sys.GoosDarwin*sys.GoarchArm64)*(1-sys.GoarchWasm))*39 + sys.GoosDarwin*sys.GoarchArm64*31 + sys.GoarchWasm*31 + (1-_64bit)*(32-(sys.GoarchMips+sys.GoarchMipsle))
