...
func init() {
	...
	var WasmOps = []opData{
		...
		{name: "LoweredConvert", argLength: 2, reg: regInfo{inputs: []regMask{gp}, outputs: []regMask{gp}}, resultInArg0: true},
		...
		{name: "I64Add", asm: "I64Add", argLength: 2, reg: gp21, typ: "Int64", commutative: true},
		...
		{name: "I64Mul", asm: "I64Mul", argLength: 2, reg: gp21, typ: "Int64", commutative: true},
		...
		{name: "I64And", asm: "I64And", argLength: 2, reg: gp21, typ: "Int64", commutative: true},
		{name: "I64Or", asm: "I64Or", argLength: 2, reg: gp21, typ: "Int64", commutative: true},
		{name: "I64Xor", asm: "I64Xor", argLength: 2, reg: gp21, typ: "Int64", commutative: true},
		...
		{name: "F64Add", asm: "F64Add", argLength: 2, reg: fp21, typ: "Float64", commutative: true},
		{name: "F64Sub", asm: "F64Sub", argLength: 2, reg: fp21, typ: "Float64"},
		{name: "F64Mul", asm: "F64Mul", argLength: 2, reg: fp21, typ: "Float64", commutative: true},
