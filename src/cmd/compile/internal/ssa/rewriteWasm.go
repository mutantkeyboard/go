...
func rewriteValueWasm(v *Value) bool {
	...
	case OpCvt:
		return rewriteValueWasm_OpCvt_0(v)
	case OpCvt32Fto32:
	...
	case OpWasmCoerce:
		return rewriteValueWasm_OpWasmCoerce_0(v)
	case OpWasmI64Add:
	...
	case OpWasmToInt16:
		return rewriteValueWasm_OpWasmToInt16_0(v)
	case OpWasmToInt32:
		return rewriteValueWasm_OpWasmToInt32_0(v)
	case OpWasmToInt8:
		return rewriteValueWasm_OpWasmToInt8_0(v)
	case OpWasmToUInt16:
		return rewriteValueWasm_OpWasmToUInt16_0(v)
	case OpWasmToUInt32:
		return rewriteValueWasm_OpWasmToUInt32_0(v)
	case OpWasmToUInt8:
		return rewriteValueWasm_OpWasmToUInt8_0(v)
	case OpXor16:
...
func rewriteValueWasm_OpAdd16_0(v *Value) bool {
	...
	// match: (Add16 x y)
	// cond:
	// result: (Coerce (I64Add x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmI64Add, typ.Int64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpCom16_0(v *Value) bool {
	...
	// match: (Com16 x)
	// cond:
	// result: (Coerce (I64Xor x (I64Const [-1])))
	for {
		x := v.Args[0]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmI64Xor, typ.Int64)
		v0.AddArg(x)
...
func rewriteValueWasm_OpConst16_0(v *Value) bool {
	// match: (Const16 <t> [val])
	// cond: !t.IsSigned()
	// result: (I64Const [int64(uint16(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(!t.IsSigned()) {
		...
		v.AuxInt = int64(uint16(val))
		return true
	}
	// match: (Const16 <t> [val])
	// cond: t.IsSigned()
	// result: (I64Const [int64(int16(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(t.IsSigned()) {
...
func rewriteValueWasm_OpConst32_0(v *Value) bool {
	// match: (Const32 <t> [val])
	// cond: !t.IsSigned()
	// result: (I64Const [int64(uint32(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(!t.IsSigned()) {
		...
		v.reset(OpWasmI64Const)
		v.AuxInt = int64(uint32(val))
		return true
	}
	// match: (Const32 <t> [val])
	// cond: t.IsSigned()
	// result: (I64Const [int64(int32(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(t.IsSigned()) {
...
func rewriteValueWasm_OpConst8_0(v *Value) bool {
	// match: (Const8 <t> [val])
	// cond: !t.IsSigned()
	// result: (I64Const [int64(uint8(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(!t.IsSigned()) {
		...
		v.reset(OpWasmI64Const)
		v.AuxInt = int64(uint8(val))
		return true
	}
	// match: (Const8 <t> [val])
	// cond: t.IsSigned()
	// result: (I64Const [int64(int8(val))])
	for {
		t := v.Type
		val := v.AuxInt
		if !(t.IsSigned()) {
...
func rewriteValueWasm_OpCvt_0(v *Value) bool {
	// match: (Cvt <t> x)
	// cond: t.Size() == 8
	// result: x
	for {
...
func rewriteValueWasm_OpCvt32Fto32_0(v *Value) bool {
	...
	// match: (Cvt32Fto32 x)
	// cond:
	// result: (Coerce (I64TruncSF64 x))
	for {
		x := v.Args[0]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmI64TruncSF64, typ.Int64)
		v0.AddArg(x)
		v.AddArg(v0)
		return true
	}
...
func rewriteValueWasm_OpDiv16_0(v *Value) bool {
	...
	// match: (Div16 x y)
	// cond:
	// result: (Coerce (I64DivS x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmI64DivS, typ.Int64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpLsh64x64_0(v *Value) bool {
	...
	// match: (Lsh64x64 x y)
	// cond:
	// result: (Coerce (Select <typ.UInt64> (I64Shl x y) (I64Const [0]) (I64LtU y (I64Const [64]))))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmSelect, typ.UInt64)
		v1 := b.NewValue0(v.Pos, OpWasmI64Shl, typ.Int64)
		v1.AddArg(x)
		v1.AddArg(y)
		v0.AddArg(v1)
...
func rewriteValueWasm_OpMul16_0(v *Value) bool {
	...
	// match: (Mul16 x y)
	// cond:
	// result: (Coerce (I64Mul x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmCoerce)
		v0 := b.NewValue0(v.Pos, OpWasmI64Mul, typ.Int64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpNeg16_0(v *Value) bool {
	...
	// match: (Neg16 x)
	// cond:
	// result: (Coerce (I64Sub (I64Const [0]) x))
	for {
		x := v.Args[0]
		v.reset(OpWasmCoerce)
...
func rewriteValueWasm_OpRsh16Ux16_0(v *Value) bool {
	...
	// match: (Rsh16Ux16 x y)
	// cond:
	// result: (Rsh64Ux64 (ToUInt16 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64Ux64)
		v0 := b.NewValue0(v.Pos, OpWasmToUInt16, typ.UInt16)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpRsh16x16_0(v *Value) bool {
	...
	// match: (Rsh16x16 x y)
	// cond:
	// result: (Rsh64x32 (ToInt16 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64x32)
		v0 := b.NewValue0(v.Pos, OpWasmToInt16, typ.Int16)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpRsh32Ux16_0(v *Value) bool {
	...
	// match: (Rsh32Ux16 x y)
	// cond:
	// result: (Rsh64Ux64 (ToUInt32 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64Ux64)
		v0 := b.NewValue0(v.Pos, OpWasmToUInt32, typ.UInt32)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpRsh32x16_0(v *Value) bool {
	...
	// match: (Rsh32x16 x y)
	// cond:
	// result: (Rsh64x32 (ToInt32 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64x32)
		v0 := b.NewValue0(v.Pos, OpWasmToInt32, typ.Int32)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpRsh8Ux16_0(v *Value) bool {
	...
	// match: (Rsh8Ux16 x y)
	// cond:
	// result: (Rsh64Ux64 (ToUInt8 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64Ux64)
		v0 := b.NewValue0(v.Pos, OpWasmToUInt8, typ.UInt8)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpRsh8x16_0(v *Value) bool {
	...
	// match: (Rsh8x16 x y)
	// cond:
	// result: (Rsh64x32 (ToInt8 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRsh64x32)
		v0 := b.NewValue0(v.Pos, OpWasmToInt8, typ.Int8)
		v0.AddArg(x)
		v.AddArg(v0)
		v.AddArg(y)
		return true
...
func rewriteValueWasm_OpWasmCoerce_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToInt16_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToInt32_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToInt8_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToUInt16_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToUInt32_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
...
func rewriteValueWasm_OpWasmToUInt8_0(v *Value) bool {
	b := v.Block
	_ = b
	typ := &b.Func.Config.Types
	_ = typ
