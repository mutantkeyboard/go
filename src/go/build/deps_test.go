...
var pkgDeps = map[string][]string{
	...
	"syscall":                           {"L0", "internal/race", "internal/syscall/windows/sysdll", "runtime/js", "unicode/utf16"},
	...
	"crypto/rand": {"L4", "CRYPTO", "OS", "math/big", "runtime/js", "syscall", "internal/syscall/unix"},
